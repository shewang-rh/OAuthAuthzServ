package endpoint.authorization;
import java.io.IOException;
import java.io.PrintWriter;
import javax.servlet.ServletException;
import javax.servlet.http.*;

import model.Client_db;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException{
		...
		try {
			...
			if(request.getParameter("user") == null){
				builder.setParam("redirect_uri", oauthRequest.getRedirectURI());
				builder.setParam("client_id", oauthRequest.getClientId());
				builder.setParam("response_type", oauthRequest.getResponseType());
				builder.setParam("client_role", oauthRequest.getParam("client_role"));
				OAuthResponse resp = builder.location("https://140.113.216.109:8443/OAuthAuthenServ/ask_authz").buildQueryMessage();
